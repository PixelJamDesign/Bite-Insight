...
export const HEALTH_CONDITION_INGREDIENTS: Record<string, HealthFlagEntry> = {
  ...
  candida: {
    ...
    keywords: [
      ...
      // Refined carbs — candida feeds on the sugars these break down into
      'white flour', 'refined flour', 'enriched flour', 'plain flour',
      'wheat flour', 'wholemeal flour', 'wholewheat flour', 'self-raising flour',
      'self raising flour', 'bread flour', 'rye flour', 'spelt flour',
      'cornflour', 'corn flour', 'cornstarch', 'corn starch', 'wheat starch',
      'modified starch', 'modified maize starch', 'potato starch', 'rice flour',
      'tapioca starch', 'white rice', 'white bread', 'pasta', 'breadcrumbs',
      'caramel', 'barley malt', 'rice malt syrup', 'coconut sugar', 'date syrup',
    ...
    ingredientIds: [
      ...
      'en:agave-syrup', 'en:maple-syrup', 'en:rice-syrup', 'en:date-syrup',
      'en:coconut-sugar', 'en:fruit-juice-concentrate', 'en:dried-fruit',
      'en:yeast', 'en:yeast-extract', 'en:brewers-yeast', 'en:malt-extract',
      'en:malt-vinegar', 'en:vinegar', 'en:soy-sauce',
      'en:white-flour', 'en:wheat-flour', 'en:wholemeal-flour', 'en:rye-flour',
      'en:spelt-flour', 'en:rice-flour', 'en:corn-starch', 'en:wheat-starch',
      'en:modified-starch', 'en:modified-maize-starch', 'en:potato-starch',
      'en:tapioca-starch', 'en:white-rice', 'en:white-bread', 'en:bread',
      'en:pasta', 'en:caramel',
      'en:mushroom',
    ],
  ...
  asthma: {
    ...
    keywords: [
      ...
      'monosodium glutamate', 'monopotassium glutamate', 'msg', 'glutamate',
      'glutamic acid', 'e620', 'e621', 'e622', 'e623', 'e624', 'e625',
      'bha', 'bht', 'e320', 'e321',

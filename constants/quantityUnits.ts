...
export const QUANTITY_UNITS: QuantityUnitMeta[] = [
  ...
  { key: 'unit', label: 'Units',        shortLabel: 'unit', defaultValue: 1,   step: 1,   precision: 0 },
  { key: 'pack', label: 'Packs',        shortLabel: 'pack', defaultValue: 1,   step: 0.5, precision: 1 },
  ...
  { key: 'cup',  label: 'Cups',         shortLabel: 'cup',  defaultValue: 0.5, step: 0.25, precision: 2 },
];

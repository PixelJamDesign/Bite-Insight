...
export const ALLERGY_KEYWORDS: Record<string, AllergyEntry> = {
  ...
  'Aloe Vera Allergy': {
    tags: ['aloe-vera', 'aloe'],
    keywords: [
      'aloe vera', 'aloe vera gel', 'aloe vera juice', 'aloe vera extract',
      'aloe vera powder', 'aloe vera concentrate', 'aloe vera leaf',
      'aloe vera latex', 'aloe gel', 'aloe juice', 'aloe extract',
    ],
    ingredientIds: [
      'en:aloe-vera', 'en:aloe-vera-gel', 'en:aloe-vera-juice',
      'en:aloe-vera-extract', 'en:aloe-vera-powder',
    ],
  },
  'Dairy Allergy': {
    tags: ['milk', 'dairy'],
    keywords: [
      'milk', 'whole milk', 'skimmed milk', 'semi-skimmed milk', 'skim milk',
      'full fat milk', 'dried milk', 'milk powder', 'milk solids', 'milk fat',
      'milk protein', 'casein', 'caseinate', 'sodium caseinate', 'calcium caseinate',
      'whey', 'whey protein', 'whey powder', 'whey concentrate', 'whey isolate',
      'lactalbumin', 'lactoglobulin', 'butter', 'butter oil', 'butter fat', 'ghee',
      'cream', 'double cream', 'single cream', 'soured cream', 'creme fraiche',
      'cheese', 'cheddar', 'parmesan', 'mozzarella', 'brie', 'camembert',
      'ricotta', 'cottage cheese', 'cream cheese', 'mascarpone', 'quark',
      'yoghurt', 'yogurt', 'greek yoghurt', 'kefir',
      'lactose', 'milk chocolate', 'condensed milk', 'evaporated milk',
    ],
    ingredientIds: [
      'en:milk', 'en:whole-milk', 'en:skimmed-milk', 'en:semi-skimmed-milk',
      'en:milk-powder', 'en:milk-protein', 'en:casein', 'en:caseinate',
      'en:sodium-caseinate', 'en:calcium-caseinate',
      'en:whey', 'en:whey-protein', 'en:whey-powder',
      'en:lactalbumin', 'en:lactoglobulin',
      'en:butter', 'en:butter-oil', 'en:ghee',
      'en:cream', 'en:double-cream', 'en:soured-cream', 'en:creme-fraiche',
      'en:cheese', 'en:cheddar', 'en:parmesan', 'en:mozzarella',
      'en:ricotta', 'en:cottage-cheese', 'en:cream-cheese', 'en:mascarpone',
      'en:yogurt', 'en:yoghurt', 'en:kefir',
      'en:lactose', 'en:condensed-milk', 'en:evaporated-milk',
    ],
  },
  'Raspberry Allergy': {
    tags: ['raspberry', 'raspberries'],
    keywords: [
      'raspberry', 'raspberries', 'raspberry juice', 'raspberry puree',
      'raspberry extract', 'raspberry flavour', 'raspberry flavor',
      'raspberry flavouring', 'raspberry flavoring', 'raspberry powder',
      'raspberry seed', 'raspberry seeds', 'raspberry concentrate',
      'wild raspberry', 'freeze-dried raspberry',
    ],
    ingredientIds: [
      'en:raspberry', 'en:raspberries', 'en:raspberry-juice',
      'en:raspberry-puree', 'en:raspberry-extract', 'en:raspberry-powder',
      'en:raspberry-concentrate', 'en:raspberry-seeds',
    ],
  },
};
